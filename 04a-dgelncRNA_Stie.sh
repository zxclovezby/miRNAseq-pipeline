...
do
	...
	echo -e "$g2\t: $g2_bam"
	echo -e "\n"
	$cufflinks/cuffdiff -o ./DGElncRNA_cuffdiff/$comparison -u -L $label -p $cufflinks_threads ./MergedGTFlncRNA_Stie/mergedlncRNA.gtf $bam_files &
done

mkdir DGEmRNA_cuffdiff
...
do
	...
	echo -e "$g2\t: $g2_bam"
	echo -e "\n"
	$cufflinks/cuffdiff -o ./DGEmRNA_cuffdiff/$comparison -u -L $label -p $cufflinks_threads ./MergedGTFRNA_Stie/mergedmRNA.gtf $bam_files &
done
